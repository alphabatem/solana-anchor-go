...
func (inst *FundManagerUpdateRestakingVaultDelegationStrategyInstruction) EncodeToTree(parent ag_treeout.Branches) {
	parent.Child(ag_format.Program(ProgramName, ProgramID)).
		...
		ParentFunc(func(programBranch ag_treeout.Branches) {
			programBranch.Child(ag_format.Instruction("FundManagerUpdateRestakingVaultDelegationStrategy")).
				//
...
// NewFundManagerUpdateRestakingVaultDelegationStrategyInstruction declares a new FundManagerUpdateRestakingVaultDelegationStrategy instruction with the provided parameters and accounts.
func NewFundManagerUpdateRestakingVaultDelegationStrategyInstruction(
	// Parameters:
	vault ag_solanago.PublicKey,
	operator ag_solanago.PublicKey,
