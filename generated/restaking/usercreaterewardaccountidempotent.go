...
func (inst *UserCreateRewardAccountIdempotentInstruction) EncodeToTree(parent ag_treeout.Branches) {
	parent.Child(ag_format.Program(ProgramName, ProgramID)).
		...
		ParentFunc(func(programBranch ag_treeout.Branches) {
			programBranch.Child(ag_format.Instruction("UserCreateRewardAccountIdempotent")).
				//
...
// NewUserCreateRewardAccountIdempotentInstruction declares a new UserCreateRewardAccountIdempotent instruction with the provided parameters and accounts.
func NewUserCreateRewardAccountIdempotentInstruction(
	// Parameters:
