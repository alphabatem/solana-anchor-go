...
func (inst *AdminInitializeRewardAccountInstruction) EncodeToTree(parent ag_treeout.Branches) {
	parent.Child(ag_format.Program(ProgramName, ProgramID)).
		...
		ParentFunc(func(programBranch ag_treeout.Branches) {
			programBranch.Child(ag_format.Instruction("AdminInitializeRewardAccount")).
				//
...
// NewAdminInitializeRewardAccountInstruction declares a new AdminInitializeRewardAccount instruction with the provided parameters and accounts.
func NewAdminInitializeRewardAccountInstruction(
	// Accounts:
