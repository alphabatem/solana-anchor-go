...
func TestEncodeDecode_FundManagerInitializeFundRestakingVault(t *testing.T) {
	fu := ag_gofuzz.New().NilChance(0)
	for i := 0; i < 1; i++ {
		t.Run("FundManagerInitializeFundRestakingVault"+strconv.Itoa(i), func(t *testing.T) {
			{
				{
					{
						params := new(FundManagerInitializeFundRestakingVaultInstruction)
						fu.Fuzz(params)
						...
						got := new(FundManagerInitializeFundRestakingVaultInstruction)
